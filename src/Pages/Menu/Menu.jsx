...
const Menu = () => {
  ...
  return (
    <div className="mt-[64px] bg-gray-100 lg:mt-[72px] min-h-screen">
      {/* Banner background */}
      <div
      ...
      <div>
        <div className="flex justify-center px-5 lg:px-0 items-center text-center pt-[130px] pb-[80px]">
          <div className="space-y-3">
            <p className="text-gray-400 font-semibold">TASTY AND CRUNCHY</p>
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-medium text-gray-600">
              AWESOME STARTERS
            </h2>
            <p className="max-w-[700px] md:text-base text-xs text-gray-400 pt-2 lg:pt-5">
