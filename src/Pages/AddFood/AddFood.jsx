...
const AddFood = () => {
    ...
    const handelFormSubmit = e => {
        ...
        axios.post("http://localhost:5000/all-foods", {
            data : formFields
        })
            .then(res => {
    ...
    return (
      <section className="min-h-[calc(100vh-65px)] bg-gray-100 pt-10">
        <section className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-100 py-10">
            ...
            >
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border rounded-xl focus:ring-2 focus:ring-purple-400 outline-none"
                >
                  <option value="">select catagroy</option>
